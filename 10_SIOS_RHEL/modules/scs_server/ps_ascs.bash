...
ASCS_LOG_FILE=/home/cloud-user/install/install.log
log() {
    echo `date` $* 2>&1 | tee -a $ASCS_LOG_FILE
}
...
yum -y install bzip2 iproute iputils mktemp patch  compat-sap-c++-6 libtool-ltdl nfs-utils nfs-utils-lib
# redhat-lsb
