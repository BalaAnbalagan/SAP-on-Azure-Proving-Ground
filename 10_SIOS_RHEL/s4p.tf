...
module "scs_server" {
  ...
  scs_CloudinitscriptPath = "${var.scs_CloudinitscriptPath}"
  VMAdminName = "${var.VMAdminName}"
  VMAdminPassword = "${var.VMAdminPassword}"
  scs_VMPublisherName = "${var.scs_VMPublisherName}"
  scs_VMOffer = "${var.scs_VMOffer}"
  scs_VMImageSku = "${var.scs_VMImageSku}"
  DiagnosticDiskURI = "${var.DiagnosticDiskURI}"
}
/*
module "wd_server" {
